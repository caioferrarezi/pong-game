...
function love.load()
  ...
  midFont = love.graphics.newFont('retrogaming.ttf', 16)
  ...
  sounds['wall_hit']:setVolume(0.2)
  sounds['paddle_hit']:setVolume(0.2)
...
function love.update(dt)
  ...
  elseif gameState == 'play' then
    ...
    if ball.y >= VIRTUAL_HEIGHT - ball.height - 1 then
      ball.y = VIRTUAL_HEIGHT - ball.height - 1
      ball.dy = -ball.dy
